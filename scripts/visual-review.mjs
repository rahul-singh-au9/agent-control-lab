...
try {
  ...
  await page.screenshot({
    path: fileURLToPath(new URL('desktop-audit.png', output)),
    fullPage: true,
    animations: 'disabled',
  });
  await page.getByRole('button', { name: 'Policy comparison', exact: true }).click();
  await page.screenshot({
    path: fileURLToPath(new URL('desktop-comparison.png', output)),
    fullPage: true,
    animations: 'disabled',
  });
  ...
  await page.screenshot({
    path: fileURLToPath(new URL('mobile-audit.png', output)),
    fullPage: true,
    animations: 'disabled',
  });
