...
const files = new Map([
  ...
  ['agent-control-lab-desktop.mp4', 'video/mp4'],
  ['agent-control-lab-mobile.mp4', 'video/mp4'],
  ['agent-control-lab-desktop.webm', 'video/webm'],
  ['agent-control-lab-mobile.webm', 'video/webm'],
]);
const port = Number(process.env.WALKTHROUGH_PORT ?? 8795);
